...
post '/add_review' do
    Review.create(user_id: session[:user_id], track_id: params[:track_id], review: params[:review]) unless Review.find_by(track_id: params[:track_id], user_id: session[:user_id], review: params[:review])
    binding.pry
